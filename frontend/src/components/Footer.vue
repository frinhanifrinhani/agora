            ...
            <div class="col-7 py-4 px-2 align-items-start">
                <div>
                    ...
                    <div class="d-flex align-items-center">
                        <img src="@/assets/images/footer-estrategia2030.png" width="133" height="48" alt="" style="padding-right: 16px !important;">
                        <img src="@/assets/images/footer-ms-fiocruz.png" alt="">
                        <img src="@/assets/images/footer-ms.png" alt="">
                        <img src="@/assets/images/footer-govbr.png" alt="">
                    </div>
                </div>
            </div>
        </div>
