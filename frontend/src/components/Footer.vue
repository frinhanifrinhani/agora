<template>
    ...
    <div class="row justify-content-center py-5" style="background-image: linear-gradient(360deg, #575860 0%, #3a3a3a 100%);">
        <div class="col-md-10 d-flex justify-content-between align-items-start pb-5">
            <div class="col-3 py-4 px-4 align-items-start">
                <div>
            ...
            <div class="col-7 py-4 px-2 align-items-start">
                <div>
                    ...
                    <div class="d-flex align-items-center">
                        <img src="@/assets/images/efas-rodape.png" alt="Logo estratégia Fiocruz Agenda 2030" class="px-2">
                        <img src="@/assets/images/logo-fiocruz-rodape.png" alt="Imagem Fiocruz" class="px-2">
                        <img src="@/assets/images/logo-ms-rodape.png" alt="Logo Ministério da Saúde" class="px-2">
                        <img src="@/assets/images/logo-gov-rodape.png" alt="Logo Governo Federal" class="px-2">
                    </div>
                </div>
            </div>
        </div>
