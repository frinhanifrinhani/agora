...
class EventAdminControllerTest extends TestCase
{
    ...
    protected EventAdminController $eventAdminController;
    protected $user;
    protected $token;
    ...
    {
        parent::setUp();
        $this->eventAdminService = $this->app->make(EventAdminService::class);
        $this->eventAdminController = new EventAdminController($this->eventAdminService);
    ...
    {
        $response = $this->get('/api/admin/events-url-not-found');
    ...
    {
        $response = $this->withHeader('Authorization', 'Bearer ' . $this->token)->get('/api/admin/events/0');
    ...
    public function testUpdateEmptyFieldsError()
    {
        ...
        $response = $this->put('/api/admin/events/' . $eventResponse['data']['event']['id'], $eventDataUpdate);
    ...
    public function testUpdateDuplicatedRegisterError()
    {
        ...
        $eventCreateResponse2 = $this->withHeader('Authorization', 'Bearer ' . $this->token)
            ->post('/api/admin/events', $eventData2);
        ...
        $response = $this->withHeader('Authorization', 'Bearer ' . $this->token)
            ->put('/api/admin/events/' . $eventCreateResponse2['data']['event']['id'], $eventDataUpdate);
    ...
    public function testUpdateNotFoundError()
    {
        ...
        $this->withHeader('Authorization', 'Bearer ' . $this->token)->delete('/api/admin/events/' . $eventCreateResponse['data']['event']['id']);

        $response = $this->put('/api/admin/events/' . $eventCreateResponse['data']['event']['id'], $eventDataUpdate);

        $response = $this->withHeader('Authorization', 'Bearer ' . $this->token)
            ->put('/api/admin/events/' . $eventCreateResponse['data']['event']['id'], $eventDataUpdate);
    ...
    public function testDeleteNotFoundError()
    {
        ...
        $this->withHeader('Authorization', 'Bearer ' . $this->token)->delete('/api/admin/events/' . $event->id);
        $response = $this->withHeader('Authorization', 'Bearer ' . $this->token)->delete('/api/admin/events/' . $event->id);
