...
class EventAdminService
{
    ...
    public function __construct(EventRepository $eventRepository, EventScheduleAdminService $eventScheduleAdminService, Request $request)
    {
    ...
    public function createEvents($request): JsonResponse
    {
        try {
            ...
            if ($request->has("schedule")) {
                $this->eventScheduleAdminService->createEventSchedule($request->validated(['schedule']), $eventsResponse->id);
            }
